...
ЩО ВМІЄ:
🐞 Баг-трекінг з фото та перевіркою на дублікати
📋 Тест-кейси та тест-плани
📚 Wiki з версіонуванням
🎯 Канбан-дошка з drag & drop
📊 Аналітика та ризик-метрики
📅 Календар (відпустки/лікарняні)
👤 Мій день (персональні задачі)
🤖 AI-асистент🔐 2FA та CSRF-захист
